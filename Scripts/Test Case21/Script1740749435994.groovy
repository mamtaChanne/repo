...
WebUI.callTestCase(findTestCase('Login positive'), [('username') : 'John Doe'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/td_3_1'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), comments1)
